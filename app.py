...
def sql_test():
    ...
    p15 = Post(Uid=2, Bid=1, title="P15", content="<p>1515</p>", timestamp="2021-03-21 12:01:00", text="1515")
    p16 = Post(Uid=2, Bid=1, title="P16", content="<p>1616</p>", timestamp="2021-03-21 12:01:00", text="1616")
    ...
    p20 = Post(Uid=2, Bid=1, title="Game Visual", content='<p>Found on official twitter account:<br/>'
                                                          ...
                                                          'title="" alt=""/></p>', medias=["-3701751787780283978.jpeg"],
